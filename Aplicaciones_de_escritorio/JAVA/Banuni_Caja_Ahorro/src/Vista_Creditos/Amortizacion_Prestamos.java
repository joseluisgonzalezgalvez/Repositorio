...
public class Amortizacion_Prestamos extends JPanel implements Runnable{
	...
	public void Disenio() {
      ...
      //  JT[5].setBounds(300,58,50,20);
       ...
       // JL[6].setBounds(220,58, 200,20);
        ...
        JP[4].add(JB[4]);
        JP[4].add(JB[3]);
        JB[2].addActionListener(new Control.control_vista_credito(this));
        JB[4].addActionListener(new Control.control_vista_credito(this));
        JB[3].addActionListener(new Control.control_vista_credito(this));
