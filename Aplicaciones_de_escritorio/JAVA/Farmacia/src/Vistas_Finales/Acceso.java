...
public class Acceso extends JFrame{
    ...
    public Icon quake1 = new ImageIcon( "Logito.jpeg" );
    ...
    public void Disenio(){
        ...
        Usuarios.addItem("");
        Usuarios.addItem("Servicio");
        Usuarios.addItem("Cajero");
        Usuarios.addItem("Medico");
        Usuarios.addItem("Almacenista");
        Usuarios.addItem("Con Poder");
        ...
        JP[2].setBorder(BorderFactory.createTitledBorder("Farmacias Del Istmo"));
